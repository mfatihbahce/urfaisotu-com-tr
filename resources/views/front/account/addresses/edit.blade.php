...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-primary-dark">Adres Düzenle</h1>
        <p class="text-slate-500 mt-1">{{ $address->title }}</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 max-w-2xl">
        <form action="{{ route('account.addresses.update', $address) }}" method="post" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title', $address->title) }}" placeholder="Ev, İş vb." required class="w-full rounded-xl border border-slate-200 px-4 py-2.5">
            ...
            <div>
                ...
                <input type="text" name="full_name" value="{{ old('full_name', $address->full_name) }}" required class="w-full rounded-xl border border-slate-200 px-4 py-2.5">
            ...
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone', $address->phone) }}" required class="w-full rounded-xl border border-slate-200 px-4 py-2.5">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="city" value="{{ old('city', $address->city) }}" required class="w-full rounded-xl border border-slate-200 px-4 py-2.5">
                ...
                <div>
                    ...
                    <input type="text" name="district" value="{{ old('district', $address->district) }}" required class="w-full rounded-xl border border-slate-200 px-4 py-2.5">
            ...
            <div>
                ...
                <textarea name="address" rows="3" required class="w-full rounded-xl border border-slate-200 px-4 py-2.5">{{ old('address', $address->address) }}</textarea>
            ...
            <div>
                ...
                <input type="text" name="postal_code" value="{{ old('postal_code', $address->postal_code) }}" class="w-full rounded-xl border border-slate-200 px-4 py-2.5">
            ...
            <div class="flex gap-4 pt-2">
                <button type="submit" class="px-6 py-2.5 bg-primary-dark text-white rounded-xl font-medium hover:bg-primary-dark/90">Güncelle</button>
